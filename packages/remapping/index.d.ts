...
export type Loader = (sourcefile: string) => SourceMapInput | null | undefined | void;
 ...
 */
declare function remapping(input: SourceMapInput, loader: Loader, options?: Options): SourceMap;
